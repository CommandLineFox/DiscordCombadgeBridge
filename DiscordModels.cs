...
namespace GFC_ComBadge
{
    ...
    public sealed class TokenResponse
    {
        ...
        [JsonIgnore] public DateTimeOffset ReceivedAt { get; set; } = DateTimeOffset.UtcNow;
        [JsonIgnore] public DateTimeOffset ExpiresAt => this.ReceivedAt.AddSeconds(this.ExpiresIn);
        [JsonIgnore] public bool IsExpiredSoon => DateTimeOffset.UtcNow >= this.ExpiresAt.AddMinutes(-2);
    }
